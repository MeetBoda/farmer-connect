...
time.sleep(3)  
driver.fullscreen_window()
driver.find_element(By.NAME,"create-account").click() 
time.sleep(3) 
driver.find_element(By.NAME,"user_name").send_keys("Alice")  
time.sleep(3)
driver.find_element(By.NAME,"email").send_keys("alice@gmail.com")  
time.sleep(3)
driver.find_element(By.NAME,"password").send_keys("alice123")  
time.sleep(3)
user_type_dropdown = Select(driver.find_element(By.NAME, "user_type"))
user_type_dropdown.select_by_visible_text("Farmer")
time.sleep(3)
